...
Para analizar los resultados del experimento y proponer un modelo para explicar el crecimiento de la población de bacterias primero hacemos una descripción gráfica de los datos.
...
De la Figura 1.2 se observa que tanto el mínimo como el máximo de bacterias se observó en los cultivos básicos (B), el rango de este tipo de cultivo resultó mayor que el rango del cultivo ácido. Finalmente, de este gráfico es importante notar que la mediana en los caldos de cultivo tipo ácido (A) fue mayor a la mediana en los cultivos tipo básico (B).
...
int1 <- interacciones %>% 
  ...
  labs(x = "Temperatura", y = "Bacterias Promedio", caption = "Figura: Gráfica de interacciones") + 
  theme(plot.caption = element_text(hjust = 0.5))
...
int2 <- interacciones %>% 
  ...
  labs(x = "Acidez", y = "Bacterias Promedio", caption = "Figura: Gráfica de interacciones") + 
  theme(plot.caption = element_text(hjust = 0.5))
