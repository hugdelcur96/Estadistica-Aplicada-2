...
conc1 <- datos %>%
  ...
  labs(x = "Concentración", y = "Número de bacterias", caption = "Figura 5. Número de bacterias por concentración a 30°C", color = "Caldo de cultivo") +
  theme_minimal() +
...
conc2 <- datos %>%
  ...
  ggplot(mapping = aes(x = Conc, y = Nbact)) +
  geom_jitter(mapping = aes(color = Acid), width = 0.05) +
  labs(x = "Concentración", y = "Número de bacterias", caption = "Figura 6. Número de bacterias por concentración a 60°C", color = "Caldo de cultivo") +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0.5), legend.position = "none") + 
  scale_color_discrete(labels = c("básico", "ácido")) 
```
...
conc3 <- datos %>%
  ...
  ggplot(mapping = aes(x = Conc, y = Nbact)) +
  geom_jitter(mapping = aes(color = Acid), width = 0.05) +
  labs(x = "Concentración", y = "Número de bacterias", caption = "Figura 7. Número de bacterias por concentración a 90°C", color = "Caldo de cultivo") +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0.5)) +
  scale_color_discrete(labels = c("básico", "ácido")) 
```
